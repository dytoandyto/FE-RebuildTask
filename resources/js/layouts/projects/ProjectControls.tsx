...
export const ProjectControls = ({ 
    ...
    <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-card rounded-[24px] p-3 shadow-sm border border-border mb-8 transition-all">
        ...
        <div className="relative flex-1 w-full group">
            ...
            <input
                type="text"
                placeholder="Search projects by name or priority..."
                value={searchQuery}
        ...
        <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
            <button onClick={onFilterClick} className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-background border border-border rounded-2xl px-5 h-12 text-sm font-bold text-foreground hover:bg-muted hover:border-sada-red/30 transition-all active:scale-95 shadow-sm">
