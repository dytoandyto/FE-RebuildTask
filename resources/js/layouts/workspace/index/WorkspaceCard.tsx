...
export const WorkspaceCard = ({ workspace, viewMode }: any) => {
    ...
    return (
        // 2. Bungkus seluruh area card dengan Link
        <Link 
        ...
        >
            ...
            >
                ...
                <div className={`flex items-center justify-between ${!isGrid ? 'w-1/3 gap-8' : 'pt-4 border-t border-border'}`}>
                    ...
                    {!isGrid && (
                        <div 
                            onClick={(e) => e.preventDefault()} // Mencegah klik tombol menu tembus ke link detail
                            className="p-2 hover:bg-muted rounded-xl transition-colors text-muted-foreground hover:text-foreground active:scale-90 cursor-pointer"
                        >
